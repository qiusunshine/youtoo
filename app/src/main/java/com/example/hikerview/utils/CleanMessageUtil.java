...
public class CleanMessageUtil {
    ...
    public static void clearWebViewCache(Activity context){
        try {
            if(CollectionUtil.isNotEmpty(MultiWindowManager.instance(context).getWebViewList())){
                for (HorizontalWebView webView : MultiWindowManager.instance(context).getWebViewList()) {
        ...
        try {
            com.tencent.smtt.sdk.WebView webView1 = new com.tencent.smtt.sdk.WebView(context);
