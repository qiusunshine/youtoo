        ...
        switch (sss[1]) {
            ...
            case AD_SUBSCRIBE:
                new PromptDialog(context)
                        ...
                        .setAnimationEnable(true)
                        .setTitleText("温馨提示")
                        .setContentText("剪贴板检测到广告拦截订阅地址，是否查看详情")
                        .setPositiveListener("查看详情", dialog -> {
                            dialog.dismiss();
                            try {
                                ClipboardUtil.copyToClipboard(context, "");
            ...
            case MINI_PROGRAM:
                new PromptDialog(context)
                        ...
                        .setAnimationEnable(true)
                        .setTitleText("温馨提示")
                        .setContentText("剪贴板检测到网页小程序规则，是否立即导入？")
                        .setPositiveListener("立即导入", dialog -> {
                            dialog.dismiss();
                            ClipboardUtil.copyToClipboard(context, "");
                            String ruleStr;
