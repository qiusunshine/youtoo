...
public class StringUtil {
    ...
    private final static String[] innerScheme = {"http", "hiker", "file", "/", "content", "{", "[", "x5:", SCHEME_TOAST, SCHEME_WEB, SCHEME_INPUT,
    ...
    public static String getDom(String url) {
        ...
        try {
            if (url.startsWith("hiker://empty#http")) {
                url = StringUtils.replaceOnce(url, "hiker://empty#", "");
            } else if (url.startsWith("webview://")) {
                url = StringUtils.replaceOnce(url, "webview://", "");
    ...
    public static boolean isWebUrl(String str) {
        ...
        return url.startsWith("http") || url.startsWith("file://") || url.startsWith("ftp")
                || url.startsWith("rtmp://") || url.startsWith("rtsp://") || url.startsWith("magnet:?");
    }
    ...
    public static String bytesToHexString(byte[] src) {
        return HttpHelper.bytesToHexString(src);
    }
