...
//                            if (orientation > 45 && orientation < 135) {
                                if (!isLocked()) {
                                    try {
                                        if (mActivity.get() != null) {
                                            if(!autoLand && mActivity.get().getRequestedOrientation() != ActivityInfo.SCREEN_ORIENTATION_LANDSCAPE){
                                                break;
                                            }
                                ...
                                isPortrait = false;
                            } else if (orientation > 110 && orientation < 250) {
...
//                            } else if (orientation > 225 && orientation < 315) {
                                if (!isLocked()) {
                                    try {
                                        if (mActivity.get() != null) {
                                            if(!autoLand && mActivity.get().getRequestedOrientation() != ActivityInfo.SCREEN_ORIENTATION_REVERSE_LANDSCAPE){
                                                break;
                                            }
                                ...
                                isPortrait = false;
                            } else if ((orientation > 290 && orientation < 360) || (orientation > 0 && orientation < 70)) {
