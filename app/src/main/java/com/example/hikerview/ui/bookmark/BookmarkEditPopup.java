...
public class BookmarkEditPopup extends CenterPopupView {
    ...
    public BookmarkEditPopup(@NonNull Context context) {
        super(context);
    }
    ...
    protected int getImplLayoutId() {
        return R.layout.pop_input_bookmark_add;
    }

    public BookmarkEditPopup bind(String title, List<String> groups, OkListener okListener) {
        return bind(title, null, null, null, groups, okListener);
    }

    public BookmarkEditPopup bind(String title, String titleDefault, String urlDefault, String groupPath, List<String> groups, OkListener okListener) {
        this.title = title;
    ...
    public BookmarkEditPopup bindHint(String titleHint, String urlHint){
        this.titleHint = titleHint;
        this.urlHint = urlHint;
        return this;
    }

    public BookmarkEditPopup showShortcut(boolean show){
        mShowShortcut = show;
        return this;
    }
    ...
    protected void onCreate() {
        ...
        findViewById(R.id.group_select).setOnClickListener(v -> groupImg.performClick());
