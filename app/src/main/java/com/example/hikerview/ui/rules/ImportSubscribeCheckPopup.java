...
public class ImportSubscribeCheckPopup extends CenterPopupView {
    ...
    public ImportSubscribeCheckPopup(@NonNull Context context) {
        super(context);
    }
    ...
    public ImportSubscribeCheckPopup bind(String title, String titleHint, String urlHint, OkListener okListener) {
        return bind(title, titleHint, null, urlHint, null, null, true, okListener);
    }

    public ImportSubscribeCheckPopup bind(String title, String titleHint, String titleDefault, String urlHint, String urlDefault,
    ...
    protected void onCreate() {
        ...
        update_checkbox = findViewById(R.id.update_checkbox);
        ...
        tv_confirm.setOnClickListener(v -> {
            dismiss();
            okListener.ok(titleEdit.getText().toString(), urlEdit.getText().toString(),checkBox.isChecked(), update_checkbox.isChecked());
        });
    }

    public interface OkListener {
        void ok(String title, String url, boolean checked, boolean addAndUpdate);
    }
}
