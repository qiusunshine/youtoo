package com.example.hikerview.ui.view.colorDialog;
...
public class PromptDialog extends Dialog {
    ...
    private CharSequence mTitle, mBtnText;
    ...
    private int getColorResId(int mDialogType) {
        ...
        if (DIALOG_TYPE_SUCCESS == mDialogType) {
            return R.color.color_type_success1;
        }
        if (DIALOG_TYPE_WARNING == mDialogType) {
    ...
    public PromptDialog setContentText(Object content) {
        if (content instanceof String) {
            mContent = new SpannedString((String) content);
        } else {
            mContent = (Spanned) content;
        }
        return this;
    }

    public PromptDialog setSpannedContentByStr(String content) {
        ...
        mContent = Html.fromHtml(StringUtil.convertBlankToTagP(builder.toString()));
        return this;
    }
    ...
    public PromptDialog setTheCancelable(boolean cancelable) {
