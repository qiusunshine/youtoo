...
public class PopImageLoaderNoView implements XPopupImageLoader {
    ...
    public PopImageLoaderNoView(String baseUrl) {
    ...
    public View loadImage(int position, @NonNull Object uri, @NonNull ImageViewerPopupView popupView, @NonNull PhotoView snapshot, @NonNull ProgressBar progressBar) {
        ...
        Glide.with(imageView).asDrawable().load(uri).apply(new RequestOptions()
                .placeholder(imageView.getContext().getResources().getDrawable(R.drawable.ic_loading_bg))
