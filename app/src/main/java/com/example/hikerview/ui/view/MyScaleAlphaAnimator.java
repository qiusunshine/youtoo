 ...
 * 时间：At 21:55
 */
public class MyScaleAlphaAnimator extends PopupAnimator {
    public MyScaleAlphaAnimator(View target, int animationDuration, PopupAnimation popupAnimation) {
    ...
    public void animateDismiss() {
        targetView.animate().alpha(0f).setDuration(XPopup.getAnimationDuration())
