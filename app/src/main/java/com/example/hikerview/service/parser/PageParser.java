...
public class PageParser {
    ...
    public static ArticleListRule getNextPage(ArticleListRule parent, String url, String params) throws ParseException {
        ...
        rule.setProxy(parentRule.getProxy());
    ...
    public static String getUrl(String url, String params) {
        ...
        if (extraJsonObject != null && extraJsonObject.containsKey("url") && extraJsonObject.getString("url") != null) {
            return extraJsonObject.getString("url");
        } else {
            return url;
        }
    }
    ...
    private static ArticleListPageRule parsePageRule(ArticleListRule parent, String rule, String url) throws ParseException {
        ...
        if (paramsMap.containsKey("rule")) {
            ...
            if (StringUtil.isEmpty(parentTitle)) {
                ...
                ArticleListRule articleListRule = MiniProgramRouter.INSTANCE.findArticleListRule(parentTitle);
